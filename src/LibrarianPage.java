 ...
 * LibrarianPage.java
 *
 * Created on Mar 13, 2010, 4:02:46 PM
 */
...
public class LibrarianPage extends javax.swing.JFrame {
    ...
    String member_id, membership, isbn_no, reference_no;
    LibrarianPageQuery query_class;
    ...
    public LibrarianPage() {
        ...
        {
           query_class = new LibrarianPageMSSQL();
        }
        else if(ServerDetails.database == Database.MYSQL)
        {
            //query_class = new LibrarianPageMYSQL();
        }
    ...
    private void initComponents() {
        ...
        jPopupMenu3.setInvoker(jLabel4);
        ...
        jMenuItem22.setFont(new java.awt.Font("Century Schoolbook", 0, 16));
        jMenuItem22.setText("Leave");
        jMenuItem22.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jMenuItem22MousePressed(evt);
            }
        });
        jPopupMenu3.add(jMenuItem22);
        ...
        jPopupMenu4.setInvoker(jLabel5);
        ...
        jPopupMenu5.setInvoker(jLabel2);

        jMenuItem10.setFont(new java.awt.Font("Century Schoolbook", 0, 16));
        jMenuItem10.setText("Edit Details");
        ...
        jMenuItem13.setText("Display Details");
        ...
        jPopupMenu6.setInvoker(jLabel6);

        jMenuItem14.setFont(new java.awt.Font("Century Schoolbook", 0, 16));
        jMenuItem14.setText("New Book");
        ...
        jLabel1.setBounds(20, 20, 200, 22);
        ...
        jLabel5.setBounds(50, 175, 131, 20);
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        {
            jPopupMenu5.show(jLabel2, 90, 10);
        }
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        jPopupMenu3.show(jLabel4, 60, 10);
}//GEN-LAST:event_jLabel4MouseClicked

    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        // TODO add your handling code here:
        jPopupMenu4.show(jLabel5, 80, 10);
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        ...
        jPopupMenu6.show(jLabel6, 60, 10);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        jLabel1.setText(temp + " " + ServerDetails.login_user);
        jLabel1.setSize(jLabel1.getPreferredSize());
